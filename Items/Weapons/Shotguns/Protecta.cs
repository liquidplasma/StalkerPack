...
{
    public class Protecta : BaseSemi
    {
        private enum Modes
        {
            Buckshot,
        ...
        public override SoundStyle ShootNoise { get => new("StalkerPack/Sounds/Weapons/" + nameof(Protecta) + "/shot"); }
        ...
        public override void SetDefaults()
        {
            ...
            Item.height = 22;
            Item.autoReuse = true;
            Item.value = ContentSamples.ItemsByType[ItemID.TacticalShotgun].value;
            base.SetDefaults();
        }
